...
export default function RegistrationPage() {
  ...
  const handleFileChange = (e) => {
    ...
    reader.onload = () => {
      setFormData(prevData => ({
        ...prevData,
        comprobantePagoBase64: reader.result,
      }))
    }
  ...
  const validateForm = () => {
    ...
    if (formData.comprobantePago && formData.comprobantePago.size > 5 * 1024 * 1024) {
      toast({
        title: "Archivo demasiado grande",
        description: "El comprobante de pago debe ser menor a 5MB",
        variant: "destructive",
      })
      return false
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const registrationData = {
        ...
        comprobantePagoBase64: formData.comprobantePagoBase64,
        comprobantePagoNombre: formData.comprobantePagoNombre,
      ...
      formFields.forEach(field => {
        if (formData[field.id]) {
          registrationData[field.id] = formData[field.id]
        }
      })
            ...
            {availableSpots > 0 ? (
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="comprobantePago">Comprobante de pago * (máx. 5MB)</Label>
                    <Input
                      id="comprobantePago"
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Formatos aceptados: JPG, PNG, GIF, PDF. Tamaño máximo: 5MB.
                    </p>
                  </div>
